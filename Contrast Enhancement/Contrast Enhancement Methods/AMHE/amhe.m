...
% end
PicGray=rgb2gray(PicOri);
figure(1),imshow(PicGray),title('orginal image');

h=imhist(PicGray);
figure(2),bar(0:255,imhist(PicGray),'k'),title('Histogram Of orginal Image');
...
figure(3),imshow(PicHE),title('AMHE');
figure(4),bar(0:255,imhist(PicHE),'k'),title('Histogram of AMHE');